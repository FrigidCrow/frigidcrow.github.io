...
const contentReplacements = [
  ...
  ['FrigidCrow | Creative Technologist &amp; Digital Builder', 'FrigidCrow | 全栈与 AI 产品开发者'],
  ['FrigidCrow | Creative Technologist & Digital Builder', 'FrigidCrow | 全栈与 AI 产品开发者'],
  ['Independent creative technologist building expressive websites, interactive systems and real-time 3D experiences.', '独立全栈与 AI 产品开发者，构建模型应用、后端服务、数据系统与交互界面的完整产品。'],

  ['<p>Ideas become<br>digital experiences</p>', '<p>把 AI 做成<br>可用产品</p>'],
  ['Ideas become\\ndigital experiences', '把 AI 做成\\n可用产品'],
  ['Ideas become digital experiences', '把 AI 做成可用产品'],
  ['<p>Built with</p><p>intention</p>', '<p>全栈构建</p>'],
  ['"Built with"', '"全栈构建"'],
  ['"intention"', '"全栈构建"'],
  ['Built with intention', '全栈构建'],
  ['<p>Design</p><p>code and</p><p>systems</p>', '<p>AI 产品</p><p>与开源项目</p>'],
  ['"Design"', '"AI 产品"'],
  ['"code and"', '"与开源项目"'],
  ['"systems"', '"与开源项目"'],
  ['Design code and systems', 'AI 产品与开源项目'],
  ['<p>Experience</p><p>you can build on</p>', '<p>从模型能力</p><p>到生产系统</p>'],
  ['"Experience"', '"从模型能力"'],
  ['"you can build on"', '"到生产系统"'],
  ['Experience you can build on', '从模型能力到生产系统'],

  ['FrigidCrow is an independent creative technologist working across interaction design, frontend engineering, real-time 3D and emerging technology. I turn ambitious ideas into focused digital experiences — from first prototype to production.', 'FrigidCrow，独立全栈与AI产品开发者。工作覆盖模型接入、后端服务、数据处理和前端交互。从原型到部署，再到后续迭代，我会独立完成。'],
  ['My work brings design, engineering and systems thinking into one process. The goal is not decoration alone: every interaction should clarify an idea, every technical choice should support the experience, and every prototype should be able to grow into a real product.', '这里收录我公开维护的AI产品与开源项目，包括智能体工作流、开发者工具、数据服务和个人效率系统。'],
  ['I like difficult briefs, unfamiliar tools and projects that need both taste and technical depth. My practice spans product thinking, creative development, Three.js, WebGL and rapid experimentation.', '我会同时处理界面、API、数据库、任务编排、部署和AI工作流。面对不确定需求，先做能验证的版本，再把关键链路补到可维护、可观测、能长期运行。'],
  ['The result is work that feels considered, performs well and gives people something worth remembering.', '模型适合处理模糊问题，代码适合守住确定性。两者都要在真实环境里稳定工作。'],

  ['Open to ambitious ideas\\nand meaningful collaborations', '有 AI 产品要落地\\n可以直接联系我'],
  ['Open to ambitious ideas<br>and meaningful collaborations', '有 AI 产品要落地<br>可以直接联系我'],

  ['Creative Direction', 'AI 产品设计'],
  ['Strategy &amp; concept', '需求与方案'],
  ['Strategy & concept', '需求与方案'],
  ['Experience Design', '模型应用'],
  ['Interaction &amp; motion', 'RAG 与智能体'],
  ['Interaction & motion', 'RAG 与智能体'],
  ['Engineering', '全栈开发'],
  ['Frontend systems', '前端与后端'],
  ['Realtime 3D', '后端服务'],
  ['Three.js &amp; shaders', 'API 与数据库'],
  ['Three.js & shaders', 'API 与数据库'],
  ['Prototyping', '工程交付'],
  ['Rapid experiments', '测试与部署'],
  ['Research', '实时 3D'],
  ['Emerging technology', 'Three.js 与 WebGL'],
  ['Delivery', '技术研究'],
  ['From idea to launch', '新模型与工具'],
